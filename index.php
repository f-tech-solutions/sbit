				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Welcome To SBIT</h2>
						</div>
						<form name="signin" method="post">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   <input class="btn btn-primary btn-lg btn-block" name="register" id="register" type="submit" value="Register">
									</div>
								</div>
							</div>
						</form>
