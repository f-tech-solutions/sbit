									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="department" class="custom-select form-control" required="true" autocomplete="off">
												<?php
													$query_Student = mysqli_query($conn,"select * from tblemployees join  tbldepartments where emp_id = '$get_id'")or die(mysqli_error());
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_student" id="add_student" data-toggle="modal">Update&nbsp;Student</button>
											</div>
										</div>
									</div>
								</div>
